...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (errorMessage === "Account is not Verified through Mail.") {
                toast.error(errorMessage, {
                    duration: 4000,
                    style: { background: "#fff3cd", color: "#856404" }, // yellow warning style
                });
            }
            else if (errorMessage === "User not found") {
                toast.error("Email is not registered. Please join Insight AI Club.", {
                    duration: 4000,
                    style: { background: "#f8d7da", color: "#842029" }, // red danger style
                });
            }
            else {
                toast.error(errorMessage);
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                <div className="bg-gray-900/50 backdrop-blur-lg border border-gray-700/50 rounded-2xl shadow-2xl p-8 max-h-[90vh] overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            disabled={isLoading}
                            className={`w-full py-3 text-base font-bold flex items-center justify-center gap-2 rounded-lg text-white transition-all duration-300
                                ${isLoading
